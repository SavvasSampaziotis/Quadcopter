...
void motor_command() 
{
  ...
  //OCR3A = motor_FrontR*2; //  pin 5
  //OCR4A = motor_BackL*2; //  pin 6
  PWMC_SetDutyCycle(PWM, 7, motor_FrontLf);//2 = PWML7
  PWMC_SetDutyCycle(PWM, 6, motor_BackRf);//3 = PWML6
  PWMC_SetDutyCycle(PWM, 5, motor_FrontRf);//5 = PWML5
  PWMC_SetDutyCycle(PWM, 4, motor_BackLf);//6 = PWML4
}
  /********************************************************************/
  /****           ESCs calibration                                 ****/
  /********************************************************************/
